...
var ns1 = prompt("first nameserver?\n" + clarification), ns2 = prompt("second nameserver?\n" + clarification);
console.log(ns1,ns2)
while (!ns1.match(regex)[0]) { let ns1 = prompt("first nameserver?\n" + clarification) }
while (!ns2.match(regex)[0]) { let ns2 = prompt("second nameserver?\n" + clarification) }
...
confirm('done! press enter to continue or escape to check if this actually worked') ? document.querySelector('#configure_submit_button').click() : 1/-0 // === -Infinity